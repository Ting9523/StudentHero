			...
			if ( isset( $_REQUEST['action'] ) ) {
				...
				if ( 'delete_remote_database' === $action ) {
					...
					if ( 'save' === $action ) {
						...
						// Save options.
						WPDA::set_option(
							WPDA::OPTION_PLUGIN_NAVIGATION,
							isset( $_REQUEST['navigation'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['navigation'] ) ) : 'both' // input var okay.
						);

						WPDA::set_option(
							WPDA::OPTION_PLUGIN_NAVIGATION_DEFAULT_PAGE,
							isset( $_REQUEST['navigation_default_page'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['navigation_default_page'] ) ) : 'wpda' // input var okay.
						);
						...
						if (
								$navigation_before_save != $navigation_after_save ||
								$navigation_default_page_before_save != $navigation_default_page_after_save
						) {
							// Reload page to activate new navigation settings
							echo '<script>window.location.href = "' . admin_url( 'options-general.php' ) . '?page=wpdataaccess&tab=plugin&msg=ok";</script>'; // phpcs:ignore WordPress.Security.EscapeOutput
						}
				...
				<table class="wpda-table-settings" id="wpda_table_plugin">
					...
					<tr>
						...
						<td>
							<select name="navigation">
								<option value="both" <?php echo 'both' === $navigation ? 'selected' : ''; ?>>Show submenus and dashboard</option>
								<option value="dashboard" <?php echo 'dashboard' === $navigation ? 'selected' : ''; ?>>Show dashboard only (hide submenus)</option>
								<option value="menu" <?php echo 'menu' === $navigation ? 'selected' : ''; ?>>Show submenus only (hide dashboard)</option>
							</select>
							<br/>
							<label>
								<select name="navigation_default_page">
									<option value="wpda_dashboard" <?php echo 'wpda_dashboard' === $navigation_default_page ? 'selected' : ''; ?>>Show dashboard on startup</option>
									<option value="wpda" <?php echo 'wpda' === $navigation_default_page ? 'selected' : ''; ?>>Show Data Explorer on startup</option>
									<option value="wpda_query_builder" <?php echo 'wpda_query_builder' === $navigation_default_page ? 'selected' : ''; ?>>Show Query Builder on startup</option>
									<option value="wpda_designer" <?php echo 'wpda_designer' === $navigation_default_page ? 'selected' : ''; ?>>Show Data Designer on startup</option>
									<option value="wpda_publisher" <?php echo 'wpda_publisher' === $navigation_default_page ? 'selected' : ''; ?>>Show Data Publisher on startup</option>
									<option value="wpda_wpdp" <?php echo 'wpda_wpdp' === $navigation_default_page ? 'selected' : ''; ?>>Show Data Projects on startup</option>
									<option value="wpda_templates" <?php echo 'wpda_templates' === $navigation_default_page ? 'selected' : ''; ?>>Show Project Templates on startup</option>
								</select>
					...
					<tr>
						...
						<td>
							...
							<input type="text" value="<?php echo esc_attr( get_option( 'date_format' ) ); ?>" class="item_width"
								   readonly/>
							...
							<span class="settings_line">
								...
								<label class="item_label">
									...
									<span class="item_label_text"><?php echo esc_attr( ( new \DateTime() )->format( 'Y-m-d' ) ); ?></span>
							...
							<span class="settings_line">
								...
								<label class="item_label">
									...
									<span class="item_label_text"><?php echo esc_attr( ( new \DateTime() )->format( 'm/d/Y' ) ); ?></span>
									<span class="item_label_align">
							...
							<span class="settings_line">
								...
								<label class="item_label">
									...
									<span class="item_label_text"><?php echo esc_attr( ( new \DateTime() )->format( 'd/m/Y' ) ); ?></span>
									<span class="item_label_align">
					...
					<tr>
						...
						<td>
							<span class="settings_label"><?php echo __( 'Output', 'wp-data-access' ); ?></span>
							<input type="text" value="<?php echo esc_attr( get_option( 'time_format' ) ); ?>" class="item_width"
								   readonly/>
							<?php echo __( '(WordPress format)', 'wp-data-access' ); ?>
							<br/>
							<span class="settings_line">
								...
								<label class="item_label">
									...
									<span class="item_label_text"><?php echo esc_attr( ( new \DateTime() )->format( 'H:i' ) ); ?></span>
									<span class="item_label_align">
					...
					<tr>
						...
						<td>
							...
							<br/>
							<span class="dashicons dashicons-yes"></span>
							<a href="<?php echo admin_url( 'options-general.php' ); // phpcs:ignore WordPress.Security.EscapeOutput ?>?page=wpdataaccess">
