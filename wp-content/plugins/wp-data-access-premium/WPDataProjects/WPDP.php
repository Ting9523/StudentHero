	...
	class WPDP {
		...
		public function __construct( $main_menu_slug = null ) {
			...
			if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
				$this->projects_page_title = 'Premium ' . $this->projects_page_title;
				$this->template_page_title = 'Premium ' . $this->template_page_title;
			}
		}
		...
		public function add_projects() {
			...
			$projects       = $wpdb->get_results( $query_projects, 'ARRAY_A' ); // phpcs:ignore Standard.Category.SniffName.ErrorCode
			...
			foreach ( $projects as $project ) {
				...
				$pages       = $wpdb->get_results( $query_pages, 'ARRAY_A' ); // phpcs:ignore Standard.Category.SniffName.ErrorCode
