...
class WP_Data_Access_Public {
	...
	public function enqueue_styles() {
		...
		if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
			...
			wp_register_style(
				'wpda_jqueryui_theme',
				\WPDataAccess\Premium\WPDAPRO_Data_Forms\WPDAPRO_Data_Forms_Init::DF_JQUERYUI . "themes/{$jquery_ui_styles}/jquery-ui.min.css",
				array(),
				null,
				false
			);
		...
		if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
			wp_register_style(
				...
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'css/dataTables.jqueryui.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				...
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'css/dataTables.semanticui.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				...
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'css/dataTables.foundation.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				'jquery_datatables_bootstrap3',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'css/dataTables.bootstrap.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				...
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'css/dataTables.bootstrap4.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				'jquery_datatables_bootstrap5',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'css/dataTables.bootstrap5.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				'jquery_datatables_bulma',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'css/dataTables.bulma.min.css',
				array(),
				null,
				false
			);
		...
		if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
			wp_register_style(
				...
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'css/responsive.jqueryui.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				...
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'css/responsive.semanticui.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				...
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'css/responsive.foundation.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				'jquery_datatables_responsive_bootstrap3',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'css/responsive.bootstrap.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				...
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'css/responsive.bootstrap4.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				'jquery_datatables_responsive_bootstrap5',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'css/responsive.bootstrap5.min.css',
				array(),
				null,
				false
			);
			wp_register_style(
				'jquery_datatables_responsive_bulma',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'css/responsive.bulma.min.css',
				array(),
				null,
				false
			);
		...
		if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
			...
			\WPDataAccess\Premium\WPDAPRO_Data_Publisher\WPDAPRO_Data_Publisher_Init::enqueue_styles();

			// Add inline editing.
			\WPDataAccess\Premium\WPDAPRO_Inline_Editing\WPDAPRO_Inline_Editing_Init::enqueue_styles();

			// Add data forms.
			\WPDataAccess\Premium\WPDAPRO_Data_Forms\WPDAPRO_Data_Forms_Init::enqueue_styles();

			// Panel styling.
			wp_register_style(
				'wpda_panels',
				plugins_url( '../assets/premium/css/wpda_panels.css', __FILE__ ),
				array(),
				WPDA::get_option( WPDA::OPTION_WPDA_VERSION )
			);
		}
	...
	public function enqueue_scripts() {
		...
		if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
			wp_register_script(
				'jquery_datatables_jqueryui',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'js/dataTables.jqueryui.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_semanticui',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'js/dataTables.semanticui.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_foundation',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'js/dataTables.foundation.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_bootstrap3',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'js/dataTables.bootstrap.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_bootstrap4',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'js/dataTables.bootstrap4.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_bootstrap5',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'js/dataTables.bootstrap5.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_bulma',
				WPDAPRO_Data_Publisher_Init::JDT_CORE . 'js/dataTables.bulma.min.js',
				array(),
				null,
				false
			);
		...
		if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
			wp_register_script(
				'jquery_datatables_responsive_jqueryui',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'js/responsive.jqueryui.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_responsive_semanticui',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'js/responsive.semanticui.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_responsive_foundation',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'js/responsive.foundation.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_responsive_bootstrap3',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'js/responsive.bootstrap.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_responsive_bootstrap4',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'js/responsive.bootstrap4.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_responsive_bootstrap5',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'js/responsive.bootstrap5.min.js',
				array(),
				null,
				false
			);
			wp_register_script(
				'jquery_datatables_responsive_bulma',
				WPDAPRO_Data_Publisher_Init::JDT_RESPONSIVE . 'js/responsive.bulma.min.js',
				array(),
				null,
				false
			);
		...
		if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
			// Register jQuery DataTables premium features.
			\WPDataAccess\Premium\WPDAPRO_Data_Publisher\WPDAPRO_Data_Publisher_Init::enqueue_scripts();

			// Add inline editing.
			\WPDataAccess\Premium\WPDAPRO_Inline_Editing\WPDAPRO_Inline_Editing_Init::enqueue_scripts();

			// Add data forms.
			\WPDataAccess\Premium\WPDAPRO_Data_Forms\WPDAPRO_Data_Forms_Init::enqueue_scripts();

			// WPDA dashboard panels.
			wp_register_script(
				'wpda_google_charts',
				WPDA::GOOGLE_CHARTS,
				array(),
			...
			wp_register_script(
				'wpda_panels',
				plugins_url( '../assets/premium/js/wpda_panels.js', __FILE__ ),
				array(),
				WPDA::get_option( WPDA::OPTION_WPDA_VERSION ),
				false
			);
	...
	public function register_shortcodes() {
		...
		if ( wpda_freemius()->can_use_premium_code__premium_only() ) {
			$wpdapro_forms = new \WPDataAccess\Premium\WPDAPRO_Data_Forms\WPDAPRO_Data_Forms_Init();
			add_shortcode( 'wpdadataproject', array( $wpdapro_forms, 'shortcode_wpdadataproject' ) );
			add_shortcode( 'wpdadataforms', array( $wpdapro_forms, 'shortcode_wpdadataforms' ) );
			$wpdapro_geomap = new \WPDataAccess\Premium\WPDAPRO_Geo_Location\WPDAPRO_Geo_Location_Init();
			add_shortcode( 'wpdageomap', array( $wpdapro_geomap, 'shortcode_wpdageomap' ) );
			$wpdapro_wpdawidget = new \WPDataAccess\Premium\WPDAPRO_Dashboard\WPDAPRO_Dashboard();
			add_shortcode( 'wpdawidget', array( $wpdapro_wpdawidget, 'shortcode_wpdawidget' ) );
		}
	}
	...
	public function wpdadiehard( $atts ) {
		...
		$wp_atts['project_id']  = sanitize_text_field( wp_unslash( $wp_atts['project_id'] ) ); // input var okay.
		$wp_atts['page_id']     = sanitize_text_field( wp_unslash( $wp_atts['page_id'] ) ); // input var okay.
		$wp_atts['schema_name'] = sanitize_text_field( wp_unslash( $wp_atts['schema_name'] ) ); // input var okay.
		$wp_atts['table_name']  = sanitize_text_field( wp_unslash( $wp_atts['table_name'] ) ); // input var okay.
		...
		if ( isset( $atts['filter_field_name'] ) && isset( $atts['filter_field_value'] ) ) {
			$filter_field_name  = str_replace( '`', '', sanitize_text_field( wp_unslash( $atts['filter_field_name'] ) ) ); // input var okay.
			$filter_field_value = sanitize_text_field( wp_unslash( $atts['filter_field_value'] ) ); // input var okay.
			...
			if ( count( $filter_field_name_array ) === count( $filter_field_value_array ) ) {
				...
				for ( $i = 0; $i < count( $filter_field_name_array ); $i++ ) { // phpcs:ignore Generic.CodeAnalysis.ForLoopWithTestFunctionCall, Squiz.PHP.DisallowSizeFunctionsInLoops
					$default_where .=
						( '' === $default_where ? '' : ' and ' ) .
						$wpdb->prepare(
							' `%1s` like %s ', // phpcs:ignore WordPress.DB.PreparedSQLPlaceholders
							array(
								WPDA::remove_backticks( $filter_field_name_array[ $i ] ),
								$filter_field_value_array[ $i ],
							)
						);
				}
			}
		...
		if ( '' !== $wp_atts['project_id'] && '' !== $wp_atts['page_id'] ) { // phpcs:ignore Generic.CodeAnalysis.EmptyStatement
			// Request for Data Projects page (check is performed in WPDP_List_Page).
		} else {
			// Request for table administration page.
			// Check schema name.
			if (
					'sys' === $wp_atts['schema_name'] ||
